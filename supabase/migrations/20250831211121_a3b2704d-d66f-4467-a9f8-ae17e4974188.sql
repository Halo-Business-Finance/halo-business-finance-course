-- Fix ambiguous column reference in get_secure_admin_profiles function
...
BEGIN
  ...
  -- Return secured profile data with properly qualified column names
  RETURN QUERY
  SELECT 
    p.user_id,  -- Explicitly qualify with table alias
    CASE 
