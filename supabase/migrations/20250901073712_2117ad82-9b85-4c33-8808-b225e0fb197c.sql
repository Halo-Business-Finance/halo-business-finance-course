-- Add USDA Loan Processing course (using 'beginner' as level since it's a single course)
INSERT INTO courses (id, title, description, level, image_url, is_active, order_index) VALUES
('usda-loan-processing', 'USDA Loan Processing', 'Comprehensive training on USDA rural development loan programs, including guaranteed loans, direct loans, and grant programs for agricultural and rural business financing.', 'beginner', '/src/assets/business-meeting.jpg', true, 403);
