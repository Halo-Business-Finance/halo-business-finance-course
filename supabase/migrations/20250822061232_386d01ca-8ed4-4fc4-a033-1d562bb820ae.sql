...
('lending-process', 'Commercial Lending Process & Underwriting', 'Master the streamlined commercial lending process, from application to approval, including credit analysis and risk assessment.', 7, 'advanced', '50 minutes', 7);