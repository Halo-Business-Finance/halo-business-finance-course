-- Create loan processing courses with correct level values
INSERT INTO courses (id, title, description, level, is_active, order_index) VALUES
('loan-application-processing', 'Loan Application Processing', 'Core loan application processing and documentation workflows', 'beginner', true, 1),
('loan-documentation-verification', 'Loan Documentation Verification', 'Document verification and compliance procedures', 'beginner', true, 2), 
('loan-workflow-management', 'Loan Processing Workflow Management', 'Managing loan processing workflows and timelines', 'beginner', true, 3),
('loan-closing-procedures', 'Loan Closing Procedures', 'Final loan closing and post-closing administration', 'beginner', true, 4),
