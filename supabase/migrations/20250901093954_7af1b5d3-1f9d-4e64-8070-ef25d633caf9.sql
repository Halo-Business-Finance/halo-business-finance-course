...
-- First ensure the loan-originator course exists
INSERT INTO courses (id, title, description, level, is_active, order_index) 
VALUES (
  'loan-originator', 
  'Loan Originator Professional Development', 
  'Comprehensive training program for loan originators covering all skill levels from beginner to expert', 
  'all_levels', 
  true, 
  3
