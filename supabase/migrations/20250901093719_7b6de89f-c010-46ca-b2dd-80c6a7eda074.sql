...
DROP POLICY IF EXISTS "Users can view their own roles and admins can view all" ON user_roles;
...
DROP POLICY IF EXISTS "Role assignment validation" ON user_roles;
...
-- Ensure course_content_modules has proper data for loan originator
...
BEGIN
    ...
    -- If we don't have enough modules, insert the 7 loan originator modules for each skill level
    IF module_count < 7 THEN
        -- Delete existing to avoid duplicates
        DELETE FROM course_content_modules WHERE course_id = 'loan-originator';
        
        -- Insert Beginner Loan Originator Modules
        ...
        -- Insert Intermediate Loan Originator Modules
        INSERT INTO course_content_modules (id, course_id, title, description, duration, order_index, topics, is_active) VALUES
        ...
        -- Insert Expert Loan Originator Modules
        INSERT INTO course_content_modules (id, course_id, title, description, duration, order_index, topics, is_active) VALUES
