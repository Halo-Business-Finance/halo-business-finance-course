-- First, handle foreign key constraints by updating related tables
-- Update course_documents to use new module IDs
...
-- Update course_videos to use new module IDs
...
-- Update course_articles to use new module IDs
...
-- Update course_assessments to use new module IDs
...
-- Update encrypted_course_content to use new module IDs
...
-- Update course_progress to use new module IDs
...
-- Now update the course_modules table with Halo Business Finance's actual loan products
