-- CRITICAL SECURITY FIXES: Phase 1 Implementation (Fixed)

-- Drop existing function first to avoid signature conflicts
DROP FUNCTION IF EXISTS public.run_automated_security_maintenance();
...
CREATE FUNCTION public.run_automated_security_maintenance()
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
