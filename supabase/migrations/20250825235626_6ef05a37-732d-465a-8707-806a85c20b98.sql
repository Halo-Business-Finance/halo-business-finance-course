...
-- Use DROP ... IF EXISTS and CREATE OR REPLACE for safer updates

-- Update cms_pages policies
DROP POLICY IF EXISTS "Only published pages are public" ON public.cms_pages;
DROP POLICY IF EXISTS "Authenticated users can view published pages" ON public.cms_pages;
...
DROP POLICY IF EXISTS "Authenticated users can view active menus" ON public.cms_menus;
...
DROP POLICY IF EXISTS "Authenticated users can view active menu items" ON public.cms_menu_items;
...
DROP POLICY IF EXISTS "Authenticated users can view CMS categories" ON public.cms_categories;
...
DROP POLICY IF EXISTS "Authenticated users can view tags" ON public.cms_tags;
...
DROP POLICY IF EXISTS "Authenticated users can view page tags" ON public.cms_page_tags;
