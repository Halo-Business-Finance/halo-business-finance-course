-- First create loan processing courses with valid level values
INSERT INTO courses (id, title, description, level, is_active, order_index) VALUES
('loan-application-processing', 'Loan Application Processing', 'Core loan application processing and documentation workflows', 'beginner', true, 101),
('loan-documentation-verification', 'Loan Documentation Verification', 'Document verification and compliance procedures', 'intermediate', true, 102), 
('loan-workflow-management', 'Loan Processing Workflow Management', 'Managing loan processing workflows and timelines', 'intermediate', true, 103),
('loan-closing-procedures', 'Loan Closing Procedures', 'Final loan closing and post-closing administration', 'intermediate', true, 104),
('commercial-loan-processing-advanced', 'Advanced Commercial Loan Processing', 'Complex commercial loan processing procedures', 'expert', true, 105),
('sba-loan-processing-specialist', 'SBA Loan Processing Specialist', 'Specialized SBA loan processing and compliance', 'expert', true, 106);
