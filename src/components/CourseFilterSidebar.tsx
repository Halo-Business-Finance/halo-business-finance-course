...
import { Search, Filter, ChevronDown, ChevronUp, Calendar, Tag, GraduationCap } from "lucide-react";
...
export function CourseFilterSidebar({ 
  ...
  return (
    <Card className="sticky top-4 h-fit w-80 p-6 bg-background border shadow-lg">
