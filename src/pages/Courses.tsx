                  ...
                  animationDelay: `${index * 100}ms`
                      ...
                      <CardContent className="pt-0 pb-6 relative z-10">
                        {user ? enrollmentStatus[course.id] ? <Link to={`/module/${course.modules[0]?.id}`} className="block">
                            ...
                            <Button className="w-full touch-manipulation h-11 font-medium group-hover:shadow-lg transition-all duration-300 text-white text-sm bg-blue-900 hover:bg-blue-800">
                              <span className="flex items-center gap-2">
