  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="text-center mb-12">
        ...
        <h1 className="text-4xl font-bold text-blue-600 mb-4">Our Mission</h1>
      ...
      <div className="mb-16">
        <h2 className="text-3xl font-bold text-blue-600 text-center mb-8">Our Story</h2>
      ...
      <div>
        <h2 className="text-3xl font-bold text-blue-600 text-center mb-8">Leadership Team</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {team.map((member, index) => (
            <Card key={index}>
              <CardHeader className="text-center">
                <div className="mx-auto w-20 h-20 bg-muted rounded-full mb-4"></div>
                <CardTitle className="text-blue-600">{member.name}</CardTitle>
