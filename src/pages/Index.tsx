        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center mb-12 md:mb-16">
            ...
            <div className="text-center lg:text-left space-y-4 order-1 lg:order-2">
              ...
              <div className="flex items-center justify-center lg:justify-start">
                <Badge variant="outline" className="inline-flex items-center gap-2 bg-transparent text-halo-orange border-halo-orange/30 hover:bg-halo-orange/10 text-xs md:text-sm px-3 py-1">
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center mb-12 md:mb-16">
            <div className="text-center lg:text-left space-y-4">
              ...
              <Badge variant="outline" className="inline-flex items-center gap-2 bg-transparent text-halo-orange border-halo-orange/30 hover:bg-halo-orange/10 mt-4 text-xs md:text-sm px-3 py-1">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            ...
            <Badge variant="outline" className="inline-flex items-center gap-2 bg-transparent text-halo-orange border-halo-orange/30 hover:bg-halo-orange/10">
